...
<h2>My main career goals are:</h2>
    1. Grow into a Front-End specialist with deep expertise in modern web ecosystems
    <br>
    2. Become a recognized reference in the field through consistent, high-quality work
    <br>
    3. Contribute to products that create real, measurable value for users and businesses
    <br>
    4. Join a team building technology that solves meaningful, large-scale problems
